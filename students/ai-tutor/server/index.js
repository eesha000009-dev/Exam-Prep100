...
// (Gemini proxy endpoint is attached after Express app is initialized)
...
// Gemini API proxy endpoint (placed here so `app` exists)
const GEMINI_API_KEY = process.env.GEMINI_API_KEY;
const fetch = (...args) => import('node-fetch').then(({default: fetch}) => fetch(...args));

app.post('/gemini', express.json(), async (req, res) => {
  try {
