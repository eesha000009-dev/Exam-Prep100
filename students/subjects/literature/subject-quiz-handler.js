/**
 * ============================================
 * LITERATURE SUBJECT - QUIZ RESULTS HANDLER
 * ============================================
 * This file handles quiz result collection and saving to Supabase
 * for all Literature topic files.
 */
...
const LiteratureQuiz = {
    ...
    async saveQuizResult(result) {
        console.log(`📖 LiteratureQuiz: Saving quiz result for "${result.topicTitle}"`);
    ...
    extractTopicId() {
        return window.location.pathname.split('/').pop().replace('.html', '') || 'unknown-literature-topic';
    },
...
window.LiteratureQuiz = LiteratureQuiz;
console.log('✅ LiteratureQuiz handler loaded');
