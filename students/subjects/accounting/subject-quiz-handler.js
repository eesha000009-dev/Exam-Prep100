/**
 * ============================================
 * ACCOUNTING SUBJECT - QUIZ RESULTS HANDLER
 * ============================================
 * This file handles quiz result collection and saving to Supabase
 * for all Accounting topic files.
 */
...
const AccountingQuiz = {
    ...
    async saveQuizResult(result) {
        console.log(`📊 AccountingQuiz: Saving quiz result for "${result.topicTitle}"`);
    ...
    extractTopicId() {
        return window.location.pathname.split('/').pop().replace('.html', '') || 'unknown-accounting-topic';
    },
...
window.AccountingQuiz = AccountingQuiz;
console.log('✅ AccountingQuiz handler loaded');
