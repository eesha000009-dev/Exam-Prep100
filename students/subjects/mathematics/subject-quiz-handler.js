/**
 * ============================================
 * MATHEMATICS SUBJECT - QUIZ RESULTS HANDLER
 * ============================================
 * This file handles quiz result collection and saving to Supabase
 * for all Mathematics topic files.
 */
...
const MathematicsQuiz = {
    ...
    async saveQuizResult(result) {
        console.log(`📐 MathematicsQuiz: Saving quiz result for "${result.topicTitle}"`);
    ...
    extractTopicId() {
        return window.location.pathname.split('/').pop().replace('.html', '') || 'unknown-mathematics-topic';
    },
...
window.MathematicsQuiz = MathematicsQuiz;
console.log('✅ MathematicsQuiz handler loaded');
