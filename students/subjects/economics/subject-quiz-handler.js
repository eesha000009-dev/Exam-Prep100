/**
 * ============================================
 * ECONOMICS SUBJECT - QUIZ RESULTS HANDLER
 * ============================================
 * This file handles quiz result collection and saving to Supabase
 * for all Economics topic files.
 */
...
const EconomicsQuiz = {
    ...
    async saveQuizResult(result) {
        console.log(`💰 EconomicsQuiz: Saving quiz result for "${result.topicTitle}"`);
    ...
    extractTopicId() {
        return window.location.pathname.split('/').pop().replace('.html', '') || 'unknown-economics-topic';
    },
...
window.EconomicsQuiz = EconomicsQuiz;
console.log('✅ EconomicsQuiz handler loaded');
