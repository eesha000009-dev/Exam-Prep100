/**
 * ============================================
 * ENGLISH SUBJECT - QUIZ RESULTS HANDLER
 * ============================================
 * This file handles quiz result collection and saving to Supabase
 * for all English topic files.
 */
...
const EnglishQuiz = {
    ...
    async saveQuizResult(result) {
        console.log(`📚 EnglishQuiz: Saving quiz result for "${result.topicTitle}"`);
    ...
    extractTopicId() {
        return window.location.pathname.split('/').pop().replace('.html', '') || 'unknown-english-topic';
    },
...
window.EnglishQuiz = EnglishQuiz;
console.log('✅ EnglishQuiz handler loaded');
