/**
 * ============================================
 * BIOLOGY SUBJECT - QUIZ RESULTS HANDLER
 * ============================================
 * This file handles quiz result collection and saving to Supabase
 * for all Biology topic files.
 */
...
const BiologyQuiz = {
    ...
    async saveQuizResult(result) {
        console.log(`🧬 BiologyQuiz: Saving quiz result for "${result.topicTitle}"`);
    ...
    extractTopicId() {
        return window.location.pathname.split('/').pop().replace('.html', '') || 'unknown-biology-topic';
    },
...
window.BiologyQuiz = BiologyQuiz;
console.log('✅ BiologyQuiz handler loaded');
