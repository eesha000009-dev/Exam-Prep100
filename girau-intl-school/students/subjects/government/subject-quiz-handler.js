/**
 * ============================================
 * GOVERNMENT SUBJECT - QUIZ RESULTS HANDLER
 * ============================================
 * This file handles quiz result collection and saving to Supabase
 * for all Government topic files.
 */
...
const GovernmentQuiz = {
    ...
    async saveQuizResult(result) {
        console.log(`🏛️ GovernmentQuiz: Saving quiz result for "${result.topicTitle}"`);
    ...
    extractTopicId() {
        return window.location.pathname.split('/').pop().replace('.html', '') || 'unknown-government-topic';
    },
...
window.GovernmentQuiz = GovernmentQuiz;
console.log('✅ GovernmentQuiz handler loaded');
